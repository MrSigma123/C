...
/* From now on I'll be using answer and result convention,
  thus there are present here these marks such as A: and R:
  A: represents the ANSWER submitted "by hand"
  R: represents the RESULT generated by the executable output */
